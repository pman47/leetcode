class Solution {
    public int[] platesBetweenCandles(String s, int[][] queries) {
        ...
        System.out.println(Arrays.toString(numberOfPlates));
        System.out.println(Arrays.toString(candleToTheLeft));
        System.out.println(Arrays.toString(candleToTheRight));
